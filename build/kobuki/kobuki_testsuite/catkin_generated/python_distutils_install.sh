...
echo_and_run cd "/home/eduardo/ws/kobuki/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/eduardo/ws/kobuki/src/kobuki/kobuki_testsuite/setup.py" \
    build --build-base "/home/eduardo/ws/kobuki/build/kobuki/kobuki_testsuite" \
    install \
    $DESTDIR_ARG \
